...
class IntegrationMockUser extends Fake implements User {
  @override
  final String uid;
  @override
...
class IntegrationMockUserCredential extends Fake implements UserCredential {
  @override
  final User? user;

  IntegrationMockUserCredential({this.user});
}

/// A comprehensive, stateful FakeAuthService designed for end-to-end integration testing.
/// Simulates realistic network behaviors, error scenarios, code dispatching, and credential verification.
class IntegrationFakeAuthService extends AuthService {
  ...
  IntegrationFakeAuthService({
    this.validSmsCode = '123456',
    this.currentVerificationId = 'integration_vid_1001',
    this.currentResendToken = 555,
  }) {
    _mockUser = IntegrationMockUser(
      uid: 'integration_user_uid_999',
  ...
  Future<void> verifyPhoneNumber({
    ...
    if (forceResendingToken != null) {
      currentVerificationId = 'integration_vid_resent_2002';
  ...
  Future<UserCredential> signInWithPhoneCredential({
    ...
    return IntegrationMockUserCredential(user: _mockUser);
  }
...
Widget buildIntegrationApp({
  ...
  return MaterialApp(
    title: 'Flash Ink Integration Test',
...
void main() {
  ...
  group('Milestone M2 Acceptance Criteria — Phone Auth E2E Flow', () {
    late IntegrationFakeAuthService authService;

    setUp(() {
      authService = IntegrationFakeAuthService();
    });
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(buildIntegrationApp(authService: authService));
        ...
        expect(authService.lastVerificationIdUsed, 'integration_vid_1001');
        expect(authService.lastSmsCodeUsed, '123456');
        expect(authService.updateStatusCallCount, 1);
        expect(authService.lastUpdatedUid, 'integration_user_uid_999');
